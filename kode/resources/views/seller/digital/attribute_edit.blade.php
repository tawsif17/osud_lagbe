									...
									<div>
										<div class="row">
											...
											<div class="mb-3 col-lg-12 col-md-12">
												<label for="text" class="form-label">{{translate('Text')}} <span class="text-danger">*</span></label>
												<textarea class="form-control" name="text" id="text" placeholder="{{translate('Text format e.g key1,key2,key3')}}"></textarea>
											</div>
										</div>
									</div>
